...
const Warrior = () => {
  return (
    <div className="h-[100vh] w-full text-black">
      ...
      <div className="flex gap-8 w-3/4 m-auto flex-col lg:flex-row">
        <div className="w-1/3 flex flex-col mx-h-[50vh]">
          <img
            src={person}
            alt=""
        ...
        <div className="w-2/3 rounded-br-3xl text-xl text-white p-12 font-primary  bg-gradient-to-br from-primary to-dark">
